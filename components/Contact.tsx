          ...
          <div className="space-y-4">
            {contactLinks.map((link) => (
              <a
                ...
                className={`flex items-center gap-4 p-4 rounded-xl border border-slate-200 hover:border-indigo-200 hover:shadow-sm transition-all group text-gray-500 ${link.color}`}
              >
